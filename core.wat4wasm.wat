(module
	...
	(import "Reflect" "apply"                    (func $self.Reflect.apply<ref.fun.ref>ref                     (param externref funcref externref) (result externref)))
	(import "Array" "of"                         (func $self.Array.of<ref.i32>ref                              (param externref i32) (result externref)))
	(import "WebAssembly" "compile"              (func $self.WebAssembly.compile<ref>ref                       (param externref) (result externref)))
	(import "console" "warn"                     (func $self.console.warn<ref.ref.i32>                         (param externref externref i32)))
	(import "WebAssembly" "compile"              (func $self.WebAssembly.compile<ref.ref>ref                   (param externref externref) (result externref)))
	...
	(global $self.Function:bind                             (mut externref) ref.null extern)
	(global $self.Promise:then                              (mut externref) ref.null extern)
	...
	(func $chain_manager.on_compile<i32.ref>
		...
		(call $self.console.warn<ref.i32> (table.get $extern (i32.const 40)) (local.get $chain_ptr))
	)

	(func $chain_manager.start<i32>
		(param $chain_ptr                       i32)
		(local $table_index                     i32)
		(local $module_source             externref)
		(local $compile_promise           externref)
		(local $bound_function            externref)
		...
		(call $self.Reflect.apply<refx3>
			(global.get $self.Promise:then)
			(local.get $compile_promise)
			(call $self.Array.of<ref>ref (local.get $bound_function))
		)
		...
		(call $self.console.warn<ref.i32> (table.get $extern (i32.const 41)) (local.get $chain_ptr))
	)

	(func $chain_manager.alloc_chain_slot<ref>i32
		(param $module_source             externref)
		(result                                 i32)
		...
		(loop $for_each_chain_slot
			(if (call $chain.try_alloc_slot<i32>i32
				...
				(then
					...
					(call $self.console.warn<ref.i32> (table.get $extern (i32.const 42)) (local.get $chain_ptr))
	...
	(start $main) (func $main
		...
		(table.set $extern (i32.const 40) (call $wat4wasm/text (i32.const 2480) (i32.const 84)))
		(table.set $extern (i32.const 41) (call $wat4wasm/text (i32.const 2564) (i32.const 88)))
		(table.set $extern (i32.const 42) (call $wat4wasm/text (i32.const 2652) (i32.const 76)))
		(table.set $extern (i32.const 43) (call $wat4wasm/text (i32.const 2728) (i32.const 176)))
		(table.set $extern (i32.const 44) (call $wat4wasm/text (i32.const 2904) (i32.const 172)))
		(table.set $extern (i32.const 45) (call $wat4wasm/text (i32.const 3076) (i32.const 196)))
		(table.set $extern (i32.const 46) (call $wat4wasm/text (i32.const 3272) (i32.const 80)))
		(table.set $extern (i32.const 47) (call $wat4wasm/text (i32.const 3352) (i32.const 36)))
		(table.set $extern (i32.const 48) (call $wat4wasm/text (i32.const 3388) (i32.const 48)))
		(table.set $extern (i32.const 49) (call $wat4wasm/text (i32.const 3436) (i32.const 24)))
		(table.set $extern (i32.const 50) (call $wat4wasm/text (i32.const 3460) (i32.const 32)))
		(table.set $extern (i32.const 51) (call $wat4wasm/text (i32.const 3492) (i32.const 32)))
		(table.set $extern (i32.const 52) (call $wat4wasm/text (i32.const 3524) (i32.const 56)))
		(table.set $extern (i32.const 53) (call $wat4wasm/text (i32.const 3580) (i32.const 32)))
		(table.set $extern (i32.const 54) (call $wat4wasm/text (i32.const 3612) (i32.const 64)))
		(table.set $extern (i32.const 55) (call $wat4wasm/text (i32.const 3676) (i32.const 56)))
		(table.set $extern (i32.const 56) (call $wat4wasm/text (i32.const 3732) (i32.const 32)))
		(table.set $extern (i32.const 57) (call $wat4wasm/text (i32.const 3764) (i32.const 36)))
		(table.set $extern (i32.const 58) (call $wat4wasm/text (i32.const 3800) (i32.const 16)))
		(table.set $extern (i32.const 59) (call $wat4wasm/text (i32.const 3816) (i32.const 28)))
		(table.set $extern (i32.const 60) (call $wat4wasm/text (i32.const 3844) (i32.const 16)))
		(table.set $extern (i32.const 61) (call $wat4wasm/text (i32.const 3860) (i32.const 48)))
		(table.set $extern (i32.const 62) (call $wat4wasm/text (i32.const 3908) (i32.const 16)))
		(table.set $extern (i32.const 63) (call $wat4wasm/text (i32.const 3924) (i32.const 12)))
		(table.set $extern (i32.const 64) (call $wat4wasm/text (i32.const 3936) (i32.const 24)))
		(table.set $extern (i32.const 65) (call $wat4wasm/text (i32.const 3960) (i32.const 44)))
		(table.set $extern (i32.const 66) (call $wat4wasm/text (i32.const 4004) (i32.const 24)))
		(table.set $extern (i32.const 67) (call $wat4wasm/text (i32.const 4028) (i32.const 40)))
		(table.set $extern (i32.const 68) (call $wat4wasm/text (i32.const 4068) (i32.const 16)))
		(table.set $extern (i32.const 69) (call $wat4wasm/text (i32.const 4084) (i32.const 20)))
		(table.set $extern (i32.const 70) (call $wat4wasm/text (i32.const 4104) (i32.const 16)))
		(table.set $extern (i32.const 71) (call $wat4wasm/text (i32.const 4120) (i32.const 20)))
		(table.set $extern (i32.const 72) (call $wat4wasm/text (i32.const 4140) (i32.const 36)))
		(table.set $extern (i32.const 73) (call $wat4wasm/text (i32.const 4176) (i32.const 44)))
		(table.set $extern (i32.const 74) (call $wat4wasm/text (i32.const 4220) (i32.const 64)))
		(table.set $extern (i32.const 75) (call $wat4wasm/text (i32.const 4284) (i32.const 44)))
		(table.set $extern (i32.const 76) (call $wat4wasm/text (i32.const 4328) (i32.const 12)))
		(table.set $extern (i32.const 77) (call $wat4wasm/text (i32.const 4340) (i32.const 40)))
		(table.set $extern (i32.const 78) (call $wat4wasm/text (i32.const 4380) (i32.const 28)))
		(table.set $extern (i32.const 79) (call $wat4wasm/text (i32.const 4408) (i32.const 28)))
		(table.set $extern (i32.const 80) (call $wat4wasm/text (i32.const 4436) (i32.const 32)))
		(table.set $extern (i32.const 81) (call $wat4wasm/text (i32.const 4468) (i32.const 60)))
		(table.set $extern (i32.const 82) (call $wat4wasm/text (i32.const 4528) (i32.const 24)))
		(table.set $extern (i32.const 83) (call $wat4wasm/text (i32.const 4552) (i32.const 40)))
		(table.set $extern (i32.const 84) (call $wat4wasm/text (i32.const 4592) (i32.const 32)))
		(table.set $extern (i32.const 85) (call $wat4wasm/text (i32.const 4624) (i32.const 24)))
			...
			(call $wat4wasm/Reflect.get<refx2>ref
				(call $wat4wasm/Reflect.getOwnPropertyDescriptor<refx2>ref
					(call $wat4wasm/Reflect.get<refx2>ref
						(call $wat4wasm/Reflect.get<refx2>ref
							(global.get $wat4wasm/self)
							(table.get $extern (i32.const 80))
						)
						(table.get $extern (i32.const 57))
					)
					(table.get $extern (i32.const 81))
				)
				(table.get $extern (i32.const 63))
			)
		)
		...
		(global.set $self.String:charCodeAt
			(call $wat4wasm/Reflect.get<refx2>ref
				(call $wat4wasm/Reflect.get<refx2>ref
					(call $wat4wasm/Reflect.get<refx2>ref
						(global.get $wat4wasm/self)
						(table.get $extern (i32.const 82))
					)
					(table.get $extern (i32.const 57))
				)
				(table.get $extern (i32.const 83))
			)
		)
		...
		(global.set $wasm.chain_manager*   (call $new_chain_manager))
	...
	(func $load_chain<ref>i32
		...
		(call $self.console.warn<ref.ref.i32>
	...
	(func $instantiate_module<ref>
		...
		(call $self.console.warn<ref>
			(call $self.WebAssembly.compile<ref.ref>ref
				(local.get $module) (global.get $wat4wasm/self)
			)
		)
	)
